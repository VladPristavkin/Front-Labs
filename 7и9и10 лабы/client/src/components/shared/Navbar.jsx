...
import Logo from "../../assets/EdTern.png";
...
const Navbar = ({ userData, toggleLeftbar, showLeftbar }) => {
  ...
  return (
    <nav className="sticky top-0 z-20 mb-5 flex justify-center gap-10 border bg-white p-2 md:items-center md:justify-between md:px-30 lg:px-36">
