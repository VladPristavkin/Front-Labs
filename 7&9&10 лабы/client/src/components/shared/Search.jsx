    ...
    <div>
      <div className="relative">
        <input
          ...
          className="h-10 py-1 bg-white border w-full md:w-[600px] rounded-full text-sm shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-500 transition duration-300 pl-3 pr-10"
          aria-label="Search"
          autoComplete="off"
        />
        {inputValue !== "" && (
